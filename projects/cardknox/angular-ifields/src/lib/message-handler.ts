import { IfieldDataCache, Options, SubmitData, TokenData, UpdateData } from "../typings";
...
export default class MessageHandler {
  ...
  constructor(private messagePoster: MessagePoster, private options : Options, private type: string, private log: (message: string) => void) { }
  ...
  private shouldRefreshToken(data: UpdateData) {
